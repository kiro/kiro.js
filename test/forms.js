...
(function() {
  ...
  describe("Models test", function() {
    ...
    it("Shows a search form", function() {
      return show(form.search(input.text({
        "class": "input-medium search-query"
      }), button.submit('Search')));
    });
    it("Shows inline form", function() {
      return show(form.inline(input.text({
        "class": "input-small"
    ...
    it("Shows a textarea", function() {
      var value;
      value = model("text");
      return show(textarea(3).bindValue(value), span().bindText(value));
    });
    ...
    it("Tests append", function() {
      return show(append(input.text(), "@"), append(input.text(), button("Do it!"), button("Another one!")));
    });
    it("Tests prepend", function() {
      return show(prepend("@", input.text()), prepend(button("Check"), input.text()));
    });
    it("Tests search prepend/append", function() {
      return show(form.search(append(input.text({
        "class": "input-medium search-query"
    ...
    return it("Shows buttons with icons", function() {
      return show(button(icon.asterisk, "Asterisk"), form({
